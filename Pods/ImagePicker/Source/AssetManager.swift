...
open class AssetManager {
  ...
  open static func resolveAsset(_ asset: PHAsset, size: CGSize = CGSize(width: 720, height: 1_280), completion: @escaping (_ image: UIImage?) -> Void) {
  ...
  open static func resolveAssets(_ assets: [PHAsset], size: CGSize = CGSize(width: 720, height: 1_280)) -> [UIImage] {
    let imageManager = PHImageManager.default()
    let requestOptions = PHImageRequestOptions()
