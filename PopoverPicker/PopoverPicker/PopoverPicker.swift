...
//  PopoverPicker
//
//  Created by Luke Mann on 4/29/17.
...
public class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {

    public typealias PickerCallback = (_ value: String) -> Void
    ...
    public var itemsFont: UIFont = UIFont(name: "AvenirNext-Regular", size: 17)!
   ...
   public static func getPicker() -> PickerDialog {
        return PickerDialog()
    }
    ...
    public func show(_ title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", options: [[String: String]], selected: String? = nil, callback: @escaping PickerCallback) {
    ...
    fileprivate func addButtonsToView(_ container: UIView) {
        ...
        self.cancelButton.titleLabel!.font = UIFont(name: "AvenirNext-DemiBold", size: 17)!
